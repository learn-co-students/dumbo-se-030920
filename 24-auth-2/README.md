...
- What's the difference between Authentication vs Authorization?
  - Authentication: Cross-checked with user's credentials
  - Authorization: Utilizes Authentication to give admin rights

- Why don't we want to save a user's password in plaintext?
  - Once your database is compromised, all passwords are compromised


- What is hashing and how does it make password storage more secure?
  - "abc123" -> "gjrilgjroigjfjblofjb.dgkklbjflbfblxfdg.dgidgjl"
  - "def345" -> "rhurtutyrete.gsrjghlirjlgxfk.bcdgdfdfdffd"
  - "abc123" -> "gjrilgjroigjfjblofjb.dgkklbjflbfblxfdg.dgidgjl"


- What are rainbow tables and how can they defeat a password hashing strategy?
  - "password1" -> "rghukjfhjklrjlfkds/fhifilbhjflbf/gijsligjs"
  - "password2" -> "hjlrtnhklrm.ghrilbjlixjblx.fmkldkmfs"


- What is salting? What is a salt? How can it defeat a rainbow tables attack?

  - "abc123" + "grhagildj" -> "ighjlirshgildjblkxjgls/dgkjdslkgjxkldg.dkngkdz"
  - "abc123" + "ptoiihsh" -> "gurhkughrjzkdklfjldzfd.dasdsdas.qwew"
