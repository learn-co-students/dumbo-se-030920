ozzy = Pet.create(name: "Ozzy", age: 3, breed: "Poodle", password: "abc123")
dog = Pet.create(name: "Dog", age: 5, breed: "Dog", password: "abc123")
cat = Pet.create(name: "Cat", age: 74, breed: "Kitten", password: "abc123")
