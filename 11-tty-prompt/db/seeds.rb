...
superheros = Team.create(name: "Imaginary Group of Friends", user: sylwia)
superheros = Team.create(name: "Imaginary Group of Friends 1", user: sylwia)

superheros = Team.create(name: "Imaginary Group of Friends 2", user: sylwia)

superheros = Team.create(name: "Imaginary Group of Friends 3", user: sylwia)
